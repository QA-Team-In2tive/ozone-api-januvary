...
describe('Create github repository test case', () => {
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.GITLAB_TYPE_NAME) {
                        ...
                        elementHandler.toBeEqual(obj.name, constants.GITLAB_TYPE_NAME);
                        ...
                        console.log('Gitlab repository provider type id and name: ', [obj.id, obj.name]);
                        addContext(this, 'Gitlab repository provider type id and name: ' + [obj.id, obj.name]);
                    }
                }
    ...
    it('GET /provider', function (done) {
        ...
        providers.get(query.queryParam + provider_type_id)
            .end((err, res) => {
                ...
                console.log('Gitlab repository provider id and name: ', [id, name]);
                addContext(this, 'Gitlab repository provider id and name: ' + [id, name]);
    ...
    it('POST /repository', function (done) {
        const param = {
            ...
            'name': 'gitlab-' + common.getSmallCharStr(2),
        ...
        repositories.create()
            ...
            .end((err, res) => {
                ...
                // create gitlab repository id and name set in env file
                ...
                console.log('Gitlab create repository id and name: ', [res.body.id, res.body.name]);
                addContext(this, 'Gitlab create repository id and name: ' + [res.body.id, res.body.name]);
