...
describe("Create gitlab custom application test case", () => {
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.CUSTOM_APP) {
                        ...
                        console.log("Gitlab custom app type id and name: ", [obj.id, obj.name]);
                        addContext(this, "Gitlab custom app type id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === name) {
                        ...
                        console.log("Gitlab custom app registries id and name: ", [obj.id, obj.name]);
                        addContext(this, "Gitlab custom app registries id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.DEPLOY_NAME) {
                        ...
                        console.log("Gitlab custom app deploy id and name: ", [obj.id, obj.name]);
                        addContext(this, "Gitlab custom app deploy id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.SERVICE_TYPE) {
                        ...
                        console.log("Gitlab custom app k8 services id and name: ", [obj.id, obj.name]);
                        addContext(this, "Gitlab custom app k8 services id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.GITLAB_REPO_NAME) {
                        elementHandler.toBeEqual(obj.name, constants.GITLAB_REPO_NAME);
                        common.readOrWriteJsonFile("app", "custom_app", "repository_id", obj.id);

                        console.log("Gitlab custom app repositories id and name: ", [obj.id, obj.name]);
                        addContext(this, "Gitlab custom app repositories id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.BUILD_NAME) {
                        ...
                        console.log("Gitlab custom app build id and name: ", [obj.id, obj.name]);
                        addContext(this, "Gitlab custom app build id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.ENV_NAME) {
                        ...
                        console.log("Gitlab custom app env id and name: ", [obj.id, obj.name]);
                        addContext(this, "Gitlab custom app env id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
        ...
        app.create(param.customApp())
            .end((err, res) => {
                ...
                if (res.body.name === name) {
                    ...
                    console.log("Gitlab custom app creation id and name: ", [res.body.id, res.body.name]);
                    addContext(this, "Gitlab custom app creation id and name: " + [res.body.id, res.body.name]);
                }
                done();
            });
    });
