...
describe("Create bitbucket custom application test case", () => {
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.CUSTOM_APP) {
                        ...
                        console.log("Bitbucket custom app type id and name: ", [obj.id, obj.name]);
                        addContext(this, "Bitbucket custom app type id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === name) {
                        ...
                        console.log("Bitbucket custom app registries id and name: ", [obj.id, obj.name]);
                        addContext(this, "Bitbucket custom app registries id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.DEPLOY_NAME) {
                        ...
                        console.log("Bitbucket custom app deploy id and name: ", [obj.id, obj.name]);
                        addContext(this, "Bitbucket custom app deploy id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.SERVICE_TYPE) {
                        ...
                        console.log("Bitbucket custom app k8 services id and name: ", [obj.id, obj.name]);
                        addContext(this, "Bitbucket custom app k8 services id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.BIT_REPO_NAME) {
                        elementHandler.toBeEqual(obj.name, constants.BIT_REPO_NAME);
                        common.readOrWriteJsonFile("app", "custom_app", "repository_id", obj.id);

                        console.log("Bitbucket custom app repositories id and name: ", [obj.id, obj.name]);
                        addContext(this, "Bitbucket custom app repositories id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.BUILD_NAME) {
                        ...
                        console.log("Bitbucket custom app build id and name: ", [obj.id, obj.name]);
                        addContext(this, "Bitbucket custom app build id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.ENV_NAME) {
                        ...
                        console.log("Bitbucket custom app env id and name: ", [obj.id, obj.name]);
                        addContext(this, "Bitbucket custom app env id and name: " + [obj.id, obj.name]);
                    }
                }
                done();
            });
        ...
        app.create(param.customApp())
            .end((err, res) => {
                ...
                if (res.body.name === name) {
                    ...
                    console.log("Bitbucket custom app creation id and name: ", [res.body.id, res.body.name]);
                    addContext(this, "Bitbucket custom app creation id and name: " + [res.body.id, res.body.name]);
                }
                done();
            });
    });
