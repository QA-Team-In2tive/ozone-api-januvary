...
describe('Create custom application test case', () => {
    ...
    it('GET / registries', function (done) {
    ...
    it('GET / K8services', function (done) {
    ...
    it('POST / customapp', function (done) {
