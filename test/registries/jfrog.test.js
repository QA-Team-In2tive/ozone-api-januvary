...
describe('Create Jfrog registry test case', () => {
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.JFROG) {
                        ...
                        console.log('Jfrog registry provider type id and name: ', [obj.id, obj.name]);
                        addContext(this, 'Jfrog registry provider type id and name: ' + [obj.id, obj.name]);
                    }
                }
    ...
    it('GET /provider', function (done) {
        ...
        providers.get(query.queryParam + provider_type_id)
            .end((err, res) => {
                ...
                console.log('Jfrog registry provider id and name: ', [id, name]);
                addContext(this, 'Jfrog registry provider id and name: ' + [id, name]);
    ...
    it('POST /registry', function (done) {
        const param = {
            ...
            'name': 'jfrog-' + common.getSmallCharStr(2),
        ...
        registries.create(param)
            .end((err, res) => {
                ...
                // create Jfrog registry id and name set in env file
                ...
                console.log('Jfrog creation registry id and name: ', [res.body.id, res.body.name]);
                addContext(this, 'Jfrog creation registry id and name: ' + [res.body.id, res.body.name]);
