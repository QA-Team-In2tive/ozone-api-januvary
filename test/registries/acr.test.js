...
describe('Create azure container registry test case', () => {
            ...
            .end((err, res) => {
                ...
                for (const obj of res.body) {
                    if (obj.name === constants.ACR) {
                        ...
                        console.log('ACR registry provider type id and name: ', [obj.id, obj.name]);
                        addContext(this, 'ACR registry provider type id and name: ' + [obj.id, obj.name]);
                    }
                }
    ...
    it('GET /provider', function (done) {
        ...
        providers.get(query.queryParam + provider_type_id)
            .end((err, res) => {
                ...
                console.log('ACR registry provider id and name: ', [id, name]);
                addContext(this, 'ACR registry provider id and name: ' + [id, name]);
    ...
    it('POST /registry', function (done) {
        const param = {
            ...
            'name': 'acr-' + common.getSmallCharStr(4),
        ...
        registries.create(param)
            .end((err, res) => {
                ...
                console.log('ACR create registry id and name: ', [res.body.id, res.body.name]);
                addContext(this, 'ACR create registry id and name: ' + [res.body.id, res.body.name]);
